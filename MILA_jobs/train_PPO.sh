...
python /home/mila/d/daniel.bairamian/RLDiff/train_PPO.py --dataset CIFAR10    --batch_size 128  --budget 10 --order 2 --target_steps 4096 --minibatch_size 256 --num_epochs 2000  --fused_dims 64    --time_encoder_dims 32 64  --projection_dims 256 128 64  --base_dataset_path /network/scratch/d/daniel.bairamian/RLDiff_data/datasets/  --base_logs_path /network/scratch/d/daniel.bairamian/RLDiff_data/logs/PPO/IADB/ --base_AE /network/scratch/d/daniel.bairamian/RLDiff_data/logs/AE/ --base_path_diffusion /network/scratch/d/daniel.bairamian/RLDiff_data/logs/diffusion/IADB/ 
python /home/mila/d/daniel.bairamian/RLDiff/train_PPO.py --dataset CIFAR10    --batch_size 128  --budget 10 --order 1 --target_steps 4096 --minibatch_size 256 --num_epochs 2000  --fused_dims 64    --time_encoder_dims 32 64  --projection_dims 256 128 64  --base_dataset_path /network/scratch/d/daniel.bairamian/RLDiff_data/datasets/  --base_logs_path /network/scratch/d/daniel.bairamian/RLDiff_data/logs/PPO/IADB/ --base_AE /network/scratch/d/daniel.bairamian/RLDiff_data/logs/AE/ --base_path_diffusion /network/scratch/d/daniel.bairamian/RLDiff_data/logs/diffusion/IADB/ 
python /home/mila/d/daniel.bairamian/RLDiff/train_PPO.py --dataset MNIST      --batch_size 256  --budget 10 --order 1 --target_steps 4096 --minibatch_size 256 --num_epochs 2000  --fused_dims 64    --time_encoder_dims 32 64  --projection_dims 128 64 32   --base_dataset_path /network/scratch/d/daniel.bairamian/RLDiff_data/datasets/  --base_logs_path /network/scratch/d/daniel.bairamian/RLDiff_data/logs/PPO/IADB/ --base_AE /network/scratch/d/daniel.bairamian/RLDiff_data/logs/AE/ --base_path_diffusion /network/scratch/d/daniel.bairamian/RLDiff_data/logs/diffusion/IADB/  
python /home/mila/d/daniel.bairamian/RLDiff/train_PPO.py --dataset CelebAHQ   --batch_size 32   --budget 10 --order 1 --target_steps 4096 --minibatch_size 64  --num_epochs 2000  --fused_dims 256   --time_encoder_dims 32 64  --projection_dims 512 256 128 --base_dataset_path /network/scratch/d/daniel.bairamian/RLDiff_data/datasets/  --base_logs_path /network/scratch/d/daniel.bairamian/RLDiff_data/logs/PPO/IADB/ --base_AE /network/scratch/d/daniel.bairamian/RLDiff_data/logs/AE/ --base_path_diffusion /network/scratch/d/daniel.bairamian/RLDiff_data/logs/diffusion/IADB/  