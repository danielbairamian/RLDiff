...
python /home/mila/d/daniel.bairamian/RLDiff/train_IADB.py --dataset CelebAHQ   --batch_size 32  --num_epochs 200   --base_dataset_path /network/scratch/d/daniel.bairamian/RLDiff_data/datasets/  --base_logs_path /network/scratch/d/daniel.bairamian/RLDiff_data/logs/diffusion/IADB/  --block_out_channels 32 64 128 256 512 512   --up_block_types UpBlock2D AttnUpBlock2D UpBlock2D UpBlock2D UpBlock2D UpBlock2D    --down_block_types DownBlock2D DownBlock2D DownBlock2D DownBlock2D AttnDownBlock2D DownBlock2D --lr 1e-4 --weight_decay 1e-4 --lr_min 1e-5
python /home/mila/d/daniel.bairamian/RLDiff/train_IADB.py --dataset CIFAR10    --batch_size 64  --num_epochs 1000  --base_dataset_path /network/scratch/d/daniel.bairamian/RLDiff_data/datasets/  --base_logs_path /network/scratch/d/daniel.bairamian/RLDiff_data/logs/diffusion/IADB/  --block_out_channels 32 64 128 128 256 512   --up_block_types UpBlock2D AttnUpBlock2D UpBlock2D UpBlock2D UpBlock2D UpBlock2D    --down_block_types DownBlock2D DownBlock2D DownBlock2D DownBlock2D AttnDownBlock2D DownBlock2D --lr 1e-4 --weight_decay 1e-4 --lr_min 1e-5
